        ...
        <div className="pt-16 pb-12 md:pt-52 md:pb-20">
          <div>
            ...
            <div className="max-w-xl mx-auto md:max-w-none flex flex-col md:flex-row md:space-x-8 lg:space-x-16 xl:space-x-20 space-y-8 space-y-reverse md:space-y-0">
              ...
              >
                {/* Content #1 */}
                <h3 className="h3 bg-clip-text text-transparent bg-gradient-to-r from-white/60 via-white to-white/60 pb-3">
                Nossas Landing Pages são projetadas para capturar a essência do seu negócio
                </h3>
                <p className="text-lg text-slate-400 mb-8">
                e converter em resultados tangíveis.
                </p>
                <div className="mt-8 max-w-xs max-md:mx-auto space-y-2">
                  ...
                  >
                    ...
                    <span>Aumento na Conversão</span>
                  </button>
                  <button
                    className={`flex items-center text-sm font-medium text-slate-50 rounded border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${
                      tab !== 2
                  ...
                  >
                    ...
                    <span>Design Personalizado e Impactante</span>
                  </button>
                  <button
                    className={`flex items-center text-sm font-medium text-slate-50 rounded border bg-slate-800/25 w-full px-3 py-2 transition duration-150 ease-in-out hover:opacity-100 ${
                      tab !== 3
                      ...
                      >
                        <defs>
                          ...
                          >
                            ...
                            <stop offset="100%" stopColor="#1ed891" />
                          </linearGradient>
                        </defs>
                        <g fillRule="evenodd">
                          <path
